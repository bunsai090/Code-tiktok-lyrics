...
LYRICS_FILE = os.path.join(os.path.dirname(__file__), 'isip_lyrics.txt')
...
def main():
    title = 'isip - by Healy After Dark'
    ...
    if lyrics is None:
        ...
        lyrics = [
            {'text': "Hindi ko maiwasan na isipin ka", 'speed': None, 'delay': 0.0, 'start': 2, 'end': 7},
            {'text': "Tanong sa hangin kung ako ba'y naiisip mo?", 'speed': None, 'delay': 0.0, 'start': 7, 'end': 12},
            {'text': "Litong-lito litong-lito", 'speed': None, 'delay': 0.0, 'start': 13, 'end': 17},
            {'text': "Sa'yo Sa'yo Sa'yo", 'speed': None, 'delay': 0.0, 'start': 18, 'end': 22},
            {'text': "Sino ba naman ako para isipin mo?", 'speed': None, 'delay': 0.0, 'start': 23, 'end': 27.70},
            {'text': "Hindi mo ba hinihintay ang mga tawag ko?", 'speed': None, 'delay': 0.0, 'start': 28, 'end': 33},
            {'text': "Sa'yo Sa'yo Sa'yo", 'speed': None, 'delay': 0.0, 'start': 33, 'end': 37.60},
            {'text': "Litong-lito litong-lito", 'speed': None, 'delay': 0.0, 'start': 38, 'end': 41.60},
        ]
