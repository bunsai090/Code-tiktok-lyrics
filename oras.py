...
LYRICS_FILE = os.path.join(os.path.dirname(__file__), 'oras_lyrics.txt')
...
def main():
    ...
    if lyrics is None:
        ...
        lyrics = [
            {'text': "Tumatakbo ang oras...", 'speed': None, 'delay': 0.0, 'start': 1, 'end': 4},
            {'text': "ako ba'y makikiusap?", 'speed': None, 'delay': 0.0, 'start': 7, 'end': 12},
            {'text': "Sana'y mabigyan ng oras", 'speed': None, 'delay': 0.0, 'start': 14, 'end': 17.60},
            {'text': "Maiparamdam ang aking lihim na pag-ibig", 'speed': None, 'delay': 0.0, 'start': 18, 'end': 24},
            {'text': "Sana'y mabigyan ng oras", 'speed': None, 'delay': 0.0, 'start': 26.40, 'end': 29},
            {'text': "Maiparamdam ang aking lihim na pag-ibig", 'speed': None, 'delay': 0.0, 'start': 29, 'end': 35},
        ]
