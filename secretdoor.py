...
LYRICS_FILE = os.path.join(os.path.dirname(__file__), 'secret_door_lyrics.txt')
...
def main():
    title = 'Secret Door - by Arctic Monkeys'
    ...
    if lyrics is None:
        ...
        lyrics = [
            {'text': "Thought of callin' ya, but you won't pick up", 'speed': 0.136, 'delay': 0.0, 'start': None, 'end': None},
            {'text': "Nother fortnight lost in America", 'speed': 0.156, 'delay': 0.0, 'start': None, 'end': None},
            {'text': "Move to Florida, buy the car you want", 'speed': 0.162, 'delay': 0.0, 'start': None, 'end': None},
            {'text': "But it won't start up 'til you touch, touch, touch me", 'speed': 0.094, 'delay': 0.0, 'start': None, 'end': None},
            {'text': "Thought of calling ya, but you won't pick up", 'speed': 0.091, 'delay': 0.0, 'start': None, 'end': None},
            {'text': "Nother fortnight lost in America", 'speed': 0.182, 'delay': 0.0, 'start': None, 'end': None},
            {'text': "Move to Florida, buy the car you want", 'speed': 0.108, 'delay': 0.0, 'start': None, 'end': None},
            {'text': "But it won't start up 'til I touch, touch, touch you", 'speed': 0.154, 'delay': 0.0, 'start': None, 'end': None},
        ]
